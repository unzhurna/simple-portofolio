...
if not settings.DEBUG:
    ...
    SECRET_KEY = '+)h91k1)&hs!*%c*3fe)2bgqb@n6akg*e@0+d64#k@nm6gty2&'

    # SECURITY WARNING: don't run with debug turned on in production!
    DEBUG = False

    ALLOWED_HOSTS = ['unzhurna.webfactional.com']

    # Email settings
    # https://docs.djangoproject.com/en/1.9/topics/email/

    EMAIL_HOST = 'smtp.gmail.com'
    EMAIL_HOST_USER = 'r.unzhurna@gmail.com'
    EMAIL_HOST_PASSWORD = '1Sampa!9'
    EMAIL_PORT = 587
    EMAIL_USE_TLS = True
